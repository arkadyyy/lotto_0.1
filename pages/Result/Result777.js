...
const Result777 = (props) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      axios
        .get(`http://52.90.122.190:5000/results/777`, {
          headers: {
            Authorization: jwt,
          },
        })
                    ...
                    <ListItem key={index} style={{ flexDirection: "column" }}>
                      <View
                        style={{
                          //   alignSelf:"center",
                          flexDirection: "row",
                          left: EStyleSheet.value("$rem") * 16.5,
                          backgroundColor: "white",
                          borderRadius: 13,
                          height: EStyleSheet.value("$rem") * 44,
                          width: EStyleSheet.value("$rem") * 330,
                          justifyContent: "center",
                        }}
                      >
                          ...
                          (num, index) => (
                            <Text
                              ...
                              style={{
                                ...
                                borderWidth: 2,
                                width: EStyleSheet.value("$rem") * 33,
                                height: EStyleSheet.value("$rem") * 33,
                                borderColor: "white",
                                borderRadius: 18,
                                textAlign: "center",
                                textAlignVertical: "center",
                                ...
                                marginTop: EStyleSheet.value("$rem") * 10,
                                marginRight: EStyleSheet.value("$rem") * 3,
                              }}
                            >
                              {num}
                            </Text>
